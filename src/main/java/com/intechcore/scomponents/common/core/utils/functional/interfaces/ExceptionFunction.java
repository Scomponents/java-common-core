...
/**
 * {@code Function} with checked exception
 * @param <TArgument> type of the arg
 * @param <TResult> type of the result
 * @param <TException> type of the checked exception
 */
@FunctionalInterface
public interface ExceptionFunction<TArgument, TResult, TException extends Exception> {
    TResult apply(TArgument t) throws TException;
}
